...
public class Main {
	...
	/*
	 * public Main() { List<Integer> numerosIntegers = crearLista();
	 * System.out.println(numerosIntegers); List<Integer> paresNumerosIntegers =
	 * filtrarPares(numerosIntegers); System.out.println(paresNumerosIntegers);
	...
	private List<Integer> crearLista() {
		return List.of(0, 1, 2, 5, 7, 88, 5, 77, 3, 99, 2, 10, 77, 4, 6, 11);
	}
